...
func request_HelloHTTP_StreamHello_0(ctx context.Context, marshaler runtime.Marshaler, client HelloHTTPClient, req *http.Request, pathParams map[string]string) (HelloHTTP_StreamHelloClient, runtime.ServerMetadata, error) {
	var metadata runtime.ServerMetadata
...
func RegisterHelloHTTPHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelloHTTPClient) error {
	...
	mux.Handle("POST", pattern_HelloHTTP_StreamHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_HelloHTTP_StreamHello_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_HelloHTTP_StreamHello_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_HelloHTTP_StreamHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"example", "streamecho"}, ""))
)

var (
	forward_HelloHTTP_SayHello_0 = runtime.ForwardResponseMessage

	forward_HelloHTTP_StreamHello_0 = runtime.ForwardResponseStream
)
